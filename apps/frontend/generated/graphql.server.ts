...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CatalogQuery(variables: CatalogQueryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CatalogQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CatalogQueryQuery>(CatalogQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CatalogQuery', 'query');
    }
  };
}
