  ...
  return (
    <Container size="xl" className="lg:mt-2 pt-40 pb-14 text-justify">
      ...
      >
        ...
        <li>
          <h6>
            1.2. Money back guarantee. If you cancel for any reason before your
            team arrives at your place, your payment is fully and automatically
        ...
        <li>
          <h6 className="mb-0">
            ...
            Antonio V. Moreno, Executive Director of Our Maids brand and the
            Corporation, (Our Maids, Inc., a Delaware Corporation) , its colors
            and formats used on this and other sites, and any other
            communication media arising from interacting with this site.
          </h6>
          ...
          <p>
            ...
            <strong>
              {" "}
              WE CLAIM FULL INTELLECTUAL PROPERTY RIGHTS ON EVERYTHING PUBLISHED
              HEREIN.
            </strong>
          </p>
          <ol type="a" className="space-y-4">
            <li>
              ...
              written or oral means, (e-mail, phone, in person, etc.). You also
              agree that you can cancel at any time, but preferably a day before
              your scheduled date.
            </li>
            <li>
              We both also agree that our service is for a set price and the
              industry standards for cleanliness. By sending the booking form or
              booking our services by any other means, you agree to both. Our
              guarantee is that if you are not happy with the service, we will
              redo the areas in conflict at no extra cost to you.
            </li>
            <li>
              ...
              obligated to do it next working day (we are closed Sunday) for the
              same agreed fee.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ul className="list-disc">
            ...
            <li>
              ...
              materials on our Website or otherwise relating to such materials
        ...
        <li>
          ...
          <p>
            ...
            to use the materials on our Website, even if we or our authorized
        ...
        <li>
          ...
          <p>
            As a condition of your right to use the Website, you represent that
            you are of legal age to enter into a binding contract and that you
            are not a person barred from accessing the Website under the laws of
            the United States or any other country. You represent and warrant
            that any information you post or provide to us by means of the
            Website, including, without limitation, as part of any request for
            services or application form or to gain access to the Website, is
            truthful, accurate, not misleading and offered in good faith.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            with the laws of DELAWARE, and you irrevocably submit to the
            exclusive jurisdiction of, and waive any objection to venue in, the
        ...
        <li>
          ...
          <p>
            ...
            cause of action arises; otherwise, such cause of action or claim is
            permanently barred. You acknowledge and agree that this limitation
            may be shorter than the limitation provided under applicable state
            law.
          </p>
        </li>
        <li>
          ...
          <p className="mt-0">
            The Terms & Conditions may not be modified except in writing, signed
            by both parties. The Terms of Service and our Privacy Policy
      ...
      <ul className="list-disc mt-0">
        ...
        <li>
          ...
          the use of the Service or from theService infrastructure itself (for
          example, the duration of a page visit).
        </li>
        <li>
          Website refers to Our Maids Franchise, Inc, accessible from{" "}
          <a href="https://www.ourmaids.com/" target="_blank" rel="noreferrer">
      ...
      <p>
        California Residents: If you are a California resident who wishes to opt
        out of the “sale” or “sharing” of your personal information via cookies
        on this website under the California Consumer Privacy Act (“CCPA”), you
        can do so by disabling the contacting us. If you would like to opt out
        of sales and sharing via an opt out preference signal, you can do so by
        utilizing a browser extension that supports opt out preference signals.
      </p>
      <p>
        Virginia Residents: If you are a Virginia resident and you would like to
        opt out of targeted advertising pursuant to the Virginia Consumer Data
        Privacy Act (“VCDPA”), you can do so by contacting us. For more
        information about your rights as a California or Virginia resident, read
        below.
      </p>
      ...
      <p className="mb-0">
        ...
        Policy. We can delete your information from our storage systems
        immediately upon your request by any means. We cannot, however, delete
        or be responsible for information collected from third party sources
      ...
      <p>
        ...
        hardware information (e.g. the type of browser and operating system your
        device uses, language preference, access time, etc.) in order to enhance
        the functionality of our Site. We may also collect information on your
        activity on the Site (e.g. pages viewed, online browsing, clicks,
        actions, etc.).
      </p>
      <p className="mb-0">
      ...
      <ul>
        <li>
          When you voluntarily provide us your personal details by phone, e-mail
          or the contact forms on our website in order to get our services;
        </li>
        <li>
      ...
      <p>
        ...
        activities or other wrongdoing, suspected fraud or security issues; (iv)
        to establish or exercise our rights to defend against legal claims; (v)
        prevent harm to the rights, property or safety of us, our users,
        yourself or any third party; or (vi) for the purpose of collaborating
        with law enforcement agencies and/or in case we find it necessary in
      ...
      <ol type="1">
        ...
        <li>
          Receive a copy of personal information you directly volunteer to us in
      ...
      <p>
        ...
        that is collected and the purpose for which it is collected, bearing in
      ...
      <p>
        ...
        however, if you choose to disable cookies, some features of our Site may
        not operate properly and your online experience may be limited.
      </p>
      <p>
        “Third party Analytics” Google Analytics collects information about your
        use of the Site. Google Analytics collects information such as how often
        users access the Site, what pages they visit when they do so, etc. We
        use the information we get from Google Analytics only to improve our
        Site and services. Analytics collects the IP address assigned to you on
        the date you visit sites, rather than your name or other identifying
        information. We do not combine the information collected through the use
        of Google Analytics with personally identifiable information.
      </p>
      ...
      <p>
        ...
        do not own or control, or to individuals whom we do not employ or
      ...
      <p>
        ...
        hard disc as soon as we collect it, is not available online or any cloud
        storage and is accessible by Our Maids Franchise, Inc. authorized
        personnel only.
      </p>
      ...
      <p className="mt-0">
        ...
        such cases we will transfer your data only to such countries as approved
        by the European Commission as providing adequate level of data
        protection, or enter into legal agreements ensuring an adequate level of
        data protection.
      </p>
      ...
      <p>
        ...
        offers from us. If you unsubscribe we will remove your email address or
        telephone number from our marketing distribution lists.
      </p>
      <p>
        Please note that even if you have unsubscribed from receiving marketing
        emails from us, we may send you other types of important e-mail
        communications without offering you the opportunity to opt out of
        receiving them. These may include customer service announcements or
      ...
      <p>
        ...
        services by minors without prior consent or authorization by a parent or
        legal guardian. We do not knowingly collect Personal Information from
        minors. If a parent or guardian becomes aware that his or her child has
        provided us with Personal Information without their consent, he or she
        should contact us at CustomerCare@OurMaids.com
      </p>
