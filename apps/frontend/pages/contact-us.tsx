...
export default function ContactUsView() {
	...
	return (
		<>
			<NextSeo
				title="Contact us to request any information."
				description="Need to request information about janitorial services, reschedule or cancel a cleaning service? OurMaids, Inc."
				openGraph={{
					type: "eCommerceSite",
					title:
						"Contact us to request any information.",
					description:
						"Need to request information about janitorial services, reschedule or cancel a cleaning service? OurMaids, Inc.",
					...
					<div className="grid grid-cols-1 md:grid-cols-12 gap-5">
						...
						<div className="md:col-start-6 md:col-end-12 mt-6 md:mt-0">
							<div>
								...
								<p>
									Use the form below to send us any message, set up an
									appointment to look at your facilities and send you a proposal
									for janitorial services, to reschedule or to cancel a
									reservation.
								</p>
								<p className="mb-0">
