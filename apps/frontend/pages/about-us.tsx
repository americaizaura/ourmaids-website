		...
		<div className="lg:mt-16 mt-40">
			...
			>
				<div>
					<p className="text-justify">All rooms:</p>
					<p>
						Wipe out picture frames, knickknacks; dust off ceiling fans, lamps;
						wipe out furniture, woodwork, shelves and baseboards. Remove
						cobwebs. Vacuum carpets. Mop all floors and dry wood floors. Vacuum
						furniture, including under any cushions. Empty and clean
						wastebaskets (trash cans).
					</p>
					<p>Bedrooms:</p>
					<p>
						In addition to all of the above paragraph, we make the beds, change
						the linens if left on the bed, straighten your vanity, organize and
						vacuum your closet if left open.
					</p>
					<p>Bathrooms:</p>
					<p>
					...
					<p>
						...
						backsplashes. Clean the range top and refrigerator top and exterior.
						Fill up the dishwasher. Clean microwave oven inside and out. Wash
						floors.
					</p>
				</div>
			</Modal>
